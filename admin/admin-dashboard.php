          ...
          <div class="row">
            ...
            <div class="col-sm">
              <?php 
                ...
                {
                  echo "
                  <table class='table table-striped table-success table-hover table-bordered text-center table-sm table-responsive table-light'>
                  ...
                  $res2 = mysqli_query($con,"SELECT * FROM exam_results ORDER BY id asc");
